    ...
    <main className="h-screen w-screen overflow-hidden relative">
      ...
      <div className="absolute right-3 top-24 z-40">
        <div className="relative">
          ...
          {settingsOpen ? (
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow p-3 text-sm">
              ...
              <div className="text-xs text-gray-500 mt-2">Route will update automatically.</div>
            </div>
          ) : null}
        </div>
      </div>
      ...
      <div className="absolute right-3 top-1/2 -translate-y-1/2 z-40">
        <div className="bg-white/95 backdrop-blur rounded-xl shadow p-4 min-w-[220px] text-sm">
          <div className="font-semibold mb-2">Route Summary</div>
          <div className="text-gray-700"><span className="font-medium">Distance:</span> {routeInfo?.distanceText ?? '—'}</div>
          <div className="text-gray-700"><span className="font-medium">Time:</span> {routeInfo?.durationText ?? '—'}</div>
